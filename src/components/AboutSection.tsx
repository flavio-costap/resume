...
function AboutSection() {
  ...
  const about = {
    ...
    en: {
      ...
      paragraph1: (
        <>
          I am a software engineer graduated in Software Engineering from the University of Brasília (UnB) and have been working in web development since 2018. Specialized in <b className="text-blue-500">front-end</b>, I have expertise in modern technologies such as <b className="text-blue-500">React</b> and <b className="text-blue-500">Vue</b>, along with knowledge in Node, Docker, continuous integration, databases, and automated testing. My experience includes creating responsive, intuitive, and scalable interfaces, always focused on providing the best user experience and efficiently meeting project needs in an innovative way.
        </>
      ),
      paragraph2: (
        <>
          Throughout my career, I have participated in high-profile projects for renowned clients such as <b className="text-blue-500">Samsung</b> and <b className="text-blue-500">Carrefour</b>, contributing with high-impact solutions. I have also developed systems for various areas, such as vehicle tracking, fiscal management, and digital marketing. I am also constantly striving to improve myself, which has led me to achieve several certifications, consolidating my ability to deliver and align with the <b className="text-blue-500">best practices</b> in the market.
        </>
      )
    }
  };
